  ...
  return (
    <div className='bg-black p-10'>
        <div className="text">
           ...
           <div className="cardPix flex gap-14 mt-10 justify-center flex-wrap">
                <Image height={80}  src={iconPix}></Image>
                ...
                <Image height={80}  src={icontroca}></Image>
                <div className="textos">
                ...
                <Image height={80}  src={iconsustentabilidade}></Image>
                <div className="textos">
